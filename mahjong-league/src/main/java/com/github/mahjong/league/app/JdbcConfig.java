...
public class JdbcConfig {
    ...
    @Value("${datasource.url:jdbc:postgresql://localhost:5432/mahjong_league}")
    private String jdbcUrl;

    @Value("${datasource.user:mahjong_league}")
    private String user;

    @Value("${datasource.password:mahjong_league}")
    ...
    public DataSource dataSource() {
        ...
        config.setPoolName("jdbc.hikaricp.mahjong-league");
